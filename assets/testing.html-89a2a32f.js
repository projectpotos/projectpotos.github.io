import{_ as n,p as s,q as a,a1 as e}from"./framework-96b046e1.js";const t={},l=e(`<h1 id="testing" tabindex="-1"><a class="header-anchor" href="#testing" aria-hidden="true">#</a> Testing</h1><p>To really test your role, we recommend to create a new branch in your spec repo and create an iso referencing that branch.</p><p>For early development of your Ansible role, you might simply checkout your role into the correct directory and create a small <code>test.yml</code> playbook to call with <code>ansible-playbook test.yml</code></p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
